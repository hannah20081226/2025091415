...
const imageSets = {
    ...
    5: ["img/tenyaku.png", "img/movie.png","img/art.png","img/news.png","img/photo.png","img/shodo.png","img/waraukai.png","img/aaf.png"],
    6: ["img/kagaku.png", "img/science.png", "img/astronomy.png","img/bio.png","img/suken.png"],
    7: ["img/game.png", "img/karuta.png", "img/english.png","img/history.png","img/run.png","img/quiz.png","img/anime.png"]
  };
